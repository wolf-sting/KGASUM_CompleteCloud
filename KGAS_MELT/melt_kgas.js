...
app.post('/api/download',(req,res)=>{
  ...
  function generateSystemAlignmentPath(dynamicPart) {
    const staticPath = `/home/ec2-user/KGAS_MELT/results/${uid}/`;
    const systemAlignmentFilename = "systemAlignment.rdf";
    const dynamicPath = `${staticPath}LocalTrack_1.0/Local+TC/%2Fhome%2Fec2-user%2FKGAS_MELT%2Fmatchers%2F${dynamicPart}/`;
...
app.post('/api/melt', (req, res) => {
    ...
    const staticPart = 'java -jar "/home/ec2-user/KGAS_MELT/matching-eval-client-latest.jar"';
    const systemsPart = `--systems "/home/ec2-user/KGAS_MELT/matchers/"${systems}""`;
    const localTestcasePart1 = `--local-testcase "/home/ec2-user/KGAS_MELT/uploads/"${localTestcase1}""`;
    const localTestcasePart2 = ` "/home/ec2-user/KGAS_MELT//uploads/"${localTestcase2}""`;
    const referencePart = `"/home/ec2-user/KGAS_MELT/uploads/"${localreference}""`;
  
    const command = `${staticPart} ${systemsPart} ${localTestcasePart1} ${localTestcasePart2} ${referencePart} > /home/ec2-user/KGAS_MELT/cmd_output/${cmdfile} --results "/home/ec2-user/KGAS_MELT/results/${resultfile}" `;
...
app.post("/api/output",(req,res)=>{
    ...
    var transporter = nodemailer.createTransport({
      ...
      var mailOptions = {
        ...
        attachments: [{
            filename: `${uid}.txt`,
            path: `/home/ec2-user/KGAS_MELT/cmd_output/${uid}.txt`
        },{
          filename:`alignmentCube.csv`,
          path:`/home/ec2-user/KGAS_MELT/results/${uid}/alignmentCube.csv`
        },{
          filename:`testCasePerformanceCube.csv`,
          path:`/home/ec2-user/KGAS_MELT/results/${uid}/testCasePerformanceCube.csv`
        },{
          filename:`trackPerformanceCube.csv`,
          path:`/home/ec2-user/KGAS_MELT/results/${uid}/trackPerformanceCube.csv`
        },{
